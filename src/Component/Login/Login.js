     ...
     <div id="logincontainer">
        ...
        <div id="loginbox">
            ...
            <div id="loginmain">
              ...
              <br/>
              <div id="logincompo2"> <input type="text" id="loginadmin" class="con"  placeholder= "Admin" 
            //    onChange={(e)=>
            // {
            ...
            /></div>
              <div id="logincompo3"> <input type="password" id="loginpass" class="con" placeholder="Password"
            //    onChange={(e)=>
            // {
            ...
            /></div>
              <br/>
              <div id="logincompo4"><button id="loginbut" >LOGIN</button></div>
              <Link to="/signIn">
